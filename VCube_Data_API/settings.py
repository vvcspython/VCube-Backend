...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'https://vvcube.pythonanywhere.com',
    'vvcube.pythonanywhere.com'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'vvcube$vcube_db',
        'USER': 'vvcube',
        'PASSWORD': 'vcube@2024',
        'HOST': 'vvcube.mysql.pythonanywhere-services.com',
        'PORT': 3306,
    }
}
...
STATIC_ROOT = '/home/vvcube/VCube_Data_API/staticfiles'

STATICFILES_DIRS = [
    '/home/vvcube/build/',
]
#'/home/<your-username>/<your-project-folder>/frontend/build/static',
# MEDIA_URL = '/media/'
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# STATIC_URL = '/static/'
# STATIC_ROOT = '/home/sirishavcube/staticfiles'
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')
